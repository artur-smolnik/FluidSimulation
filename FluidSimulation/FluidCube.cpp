...
FluidCube::FluidCube(int size, int diffusion, int viscosity, float dt)
{
	...
	std::fill_n(density, size * size * size, 0);

	this->Vx = new float[size * size * size];
	std::fill_n(Vx, size * size * size, 0);
	this->Vy = new float[size * size * size];
	std::fill_n(Vy, size * size * size, 0);
	this->Vz = new float[size * size * size];
	std::fill_n(Vz, size * size * size, 0);

	this->Vx0 = new float[size * size * size];
	std::fill_n(Vx0, size * size * size, 0);
	this->Vy0 = new float[size * size * size];
	std::fill_n(Vy0, size * size * size, 0);
	this->Vz0 = new float[size * size * size];
	std::fill_n(Vz0, size * size * size, 0);
